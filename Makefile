...
help:
	...
	@echo "  networkedge            to build components of Network Edge deployment (EAA, Edge DNS Service, Certificate Signer)"
	@echo "  networkedge-kubeovn    to build components of Kube-OVN Network Edge deployment (EAA, Edge DNS Service, Certificate Signer, Interface Service)"
...
common-services: eaa edgednssvr certsigner certrequester

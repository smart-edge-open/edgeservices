...
CU_TestInfo tests_suite_nes_dns_config[] = {
	{"nes_dns_ether_aton_test", nes_dns_ether_aton_test},
	{"nes_dns_mac_from_cfg_test", nes_dns_mac_from_cfg_test},
	{"nes_dns_ip_from_cfg_test", nes_dns_ip_from_cfg_test},
	{"nes_dns_check_forward_unresolved_test", nes_dns_check_forward_unresolved_test},
	{"nes_dns_tap_create_test", nes_dns_tap_create_test},
	CU_TEST_INFO_NULL,
};
